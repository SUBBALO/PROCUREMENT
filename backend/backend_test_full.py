"""
Full Workflow Test for Feature F+G
Tests the complete flow from DRF creation to Sales TTD auto-fill
"""
import requests
import sys
import uuid
...
class FullWorkflowTester:
    ...
    def run_full_workflow(self):
        ...
        # Login as super_admin (has all permissions and can bypass role checks)
        ...
        # Step 3: Accept DRF (as Eng Leader)
        ...
        # Step 5: Upload PDF (create a minimal PDF)
        ...
        # Step 6: Set work category (required before submit)
        ...
        # Step 7: Submit drawing (Prepared By)
        ...
        if not success:
            self.log("Drawing submit failed, but continuing...", "warn")
        ...
        if not success:
            self.log("Eng Head approval failed, but continuing...", "warn")
        ...
        if not success:
            self.log("QC approval failed, but continuing...", "warn")
        
        # Step 10: Approve as Sales (CRITICAL TEST - auto-fill so_stamp_draft)
        ...
        # Step 11: Verify so_stamp_draft was auto-filled
...
def main():
    ...
    return tester.run_full_workflow()
