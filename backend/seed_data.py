...
async def seed_users():
    ...
    users = [
        ...
        ("asiong",    "asiong123",  "Asiong Lu",       "supervisor", ["approve_store_requests", "view_store_report"]),
        # Sales team
        ...
        # Engineering team — Riski = Engineering Leader (renamed from eng_head Feb 2026), Zul = eng_head legacy, Madian & Trisna = eng_staff
        ("zul",       "eng123",     "Zul",             "eng_head", []),
        ("riski",     "eng123",     "Riski",           "eng_leader", []),
        ("madian",    "eng123",     "Madian",          "eng_staff", []),
        ("trisna",    "eng123",     "Trisna",          "eng_staff", []),
        # Purchasing team
        ("fiana",     "purch123",   "Fiana",           "purchasing", []),
        # Store team
        ("khairul",   "store123",   "Khairul",         "store",   []),
        # Legacy demo accounts kept for testing continuity
        ("staff01",   "staff123",   "Budi Santoso",    "purchasing", []),
        ("store01",   "store123",   "Rina Wulandari",  "store", []),
        ("finance01", "finance123", "Ahmad Kurniawan", "finance", []),
        ("engineer01","eng123",     "Engineering Team","eng_head", []),  # legacy = head
