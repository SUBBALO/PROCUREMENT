...
import VendorMonthlyReportPage from "./pages/VendorMonthlyReportPage";
...
import DrawingRequestMasterlistPage from "./pages/DrawingRequestMasterlistPage";
...
function AppRoutes() {
  return (
    <Routes>
      ...
      <Route path="/purchasing/vendor-report" element={<ProtectedRoute><VendorMonthlyReportPage /></ProtectedRoute>} />
      ...
      <Route path="/engineering/drawing-request-masterlist" element={<ProtectedRoute><DrawingRequestMasterlistPage /></ProtectedRoute>} />
