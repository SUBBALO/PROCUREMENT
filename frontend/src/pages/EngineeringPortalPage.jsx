...
export default function EngineeringPortalPage() {
  ...
  const CARDS = [
    ...
    {
      key: "drf-masterlist", label: "Masterlist Drawing Request", stats: "Semua DR · Status · Engineer",
      description: "Daftar seluruh Drawing Request dari semua SO beserta status (Draft/Terkirim/Dikerjakan/Selesai/Revisi) dan engineer penanggung jawab. Cari & filter cepat.",
      icon: FileText, href: "/engineering/drawing-request-masterlist",
