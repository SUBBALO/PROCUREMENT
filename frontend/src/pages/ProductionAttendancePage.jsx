    ...
    <div className="p-4 max-w-[1700px] mx-auto space-y-4" data-testid="attendance-page">
      ...
      <div className="bg-white border border-slate-200 rounded-lg overflow-hidden">
        <div className="overflow-x-auto">
          <table className="text-xs border-collapse" data-testid="attendance-month-table">
            <thead>
            ...
            <tbody>
              {loading ? (
                ...
                grid.employees.map((e) => (
                  <tr key={e.id} data-testid={`att-emp-${e.id}`}>
                    <td className="px-2 py-1 font-semibold text-slate-800 border border-slate-200 sticky left-0 bg-white z-10">{e.name}</td>
