...
export default function SOMasterPage() {
  ...
  const filteredList = useMemo(
    () => sortedList.filter((s) => !q.trim() || s.so_no?.toLowerCase().includes(q.toLowerCase()) || s.customer?.toLowerCase().includes(q.toLowerCase()) || s.description?.toLowerCase().includes(q.toLowerCase())),
    [sortedList, q]
  );
