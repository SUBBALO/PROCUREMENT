                ...
                <tr key={u.id} className="border-b border-slate-100 hover:bg-slate-50">
                  ...
                  <td className="p-3">
                    {(() => {
                      ...
                      const label = u.role === "eng_head" ? "eng head" : u.role === "eng_staff" ? "eng staff" : u.role;
                      return (
          ...
          <div>
            ...
            <Select value={form.role} onValueChange={(v) => setForm({ ...form, role: v })}>
              ...
              <SelectContent>
                ...
                <SelectItem value="eng_head">Engineering Head (bisa assign)</SelectItem>
            ...
            <div className="text-[11px] text-slate-500 mt-1 leading-relaxed">
              ...
              <b>Eng Head</b>: Riski/Zul — assign job ke engineer · <b>Eng Staff</b>: hanya kerjakan job yg di-assign, tapi tetap bisa upload BOM<br />
          ...
          <div>
            ...
            <Select value={form.role} onValueChange={(v) => setForm({ ...form, role: v })} disabled={isSelf}>
              ...
              <SelectContent>
                ...
                <SelectItem value="finance">Finance (View + Export Only)</SelectItem>
                <SelectItem value="sales">Sales</SelectItem>
                <SelectItem value="eng_head">Engineering Head</SelectItem>
